...
def test_pcp_zeroconf_install():
    ...
    :steps:
        ...
        3. Check that auto_update is set to True in /etc/insights-client/insights-client.conf
    :expectedresults:
...
def test_pmlogger_running_and_metrics_exist():
    ...
    :steps:
        ...
        3. Verify that the pmlogger service is active
    :expectedresults:
...
def test_register_with_pcp(insights_client):
    ...
    :steps:
        ...
        2. Verify the client is registered
    :expectedresults:
        1. insights-client completes the registration
